...
public class Subjective_T extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        desc1= findViewById(R.id.editTextTextMultiLine7);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String descriptionText1=desc1.getText().toString();

                //Create a model
                SubjectiveModel model = new SubjectiveModel(descriptionText,descriptionText1);
